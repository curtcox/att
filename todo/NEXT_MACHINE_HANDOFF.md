...
- Date: `2026-02-14`
- Branch: `main`
- HEAD: `c47114bb156cc37186748d9e4d64dc42bdae5770`
- Last commit: `c47114b 2026-02-14 13:45:00 -0600 - Consolidate combined adapter session listing assertion helpers`
...
1. Reuse shared expected vectors in `tests/unit/test_mcp_client.py` where this improves consistency in nearby NAT helper tests:
   - migrate any remaining nearby repeated adapter-session diagnostics/listing state assertions (especially post-invalidation/failure active-state checks and pre-invocation inactive listings) into shared helper/vector form, preferring combined helper checks where strict server-order + keyed-state assertions appear together.
