...
- Date: `2026-02-14`
- Branch: `main`
- HEAD: `60928e65abcf650fdabc2ec50e989cb7f3eefd3c`
- Last commit: `60928e6 2026-02-14 13:54:02 -0600 - Add helper for absent adapter diagnostics assertion`
...
1. Reuse shared expected vectors in `tests/unit/test_mcp_client.py` where this improves consistency in nearby NAT helper tests:
   - migrate any remaining nearby repeated adapter-session diagnostics/listing state assertions (especially post-invalidation/failure active-state checks, pre-invocation inactive listings, adapter-level diagnostics retrieval/state scaffolding, and absent-manager diagnostics checks) into shared helper/vector form, preferring combined helper checks where strict server-order + keyed-state assertions appear together.
