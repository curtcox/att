...
- Date: `2026-02-14`
- Branch: `main`
- HEAD: `e313606bd7d691b6c6c0b4f29c571624383f0aa5`
- Last commit: `e313606 2026-02-14 08:22:28 -0600 - Vectorize NAT failure-script snapshot assertion steps`
...
1. Reuse shared expected vectors in `tests/unit/test_mcp_client.py` where this improves consistency in nearby NAT helper tests:
   - migrate any remaining nearby repeated setup vectors used in failure-script helper setup/assertion sequences into shared local vectors/helpers while keeping server-name setup literals and method-branch conditionals explicit.
