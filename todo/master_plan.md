...
- [x] Completed failure-script setup/ordering/snapshot helper vectorization plus residual NAT adapter-session inactive diagnostics helper reuse in nearby cluster NAT helper coverage:
